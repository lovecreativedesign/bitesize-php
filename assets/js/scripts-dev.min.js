/*! sutest 1.0.0 filename.js 2019-12-20 5:48:50 PM */
...
(function($) {
    ...
    bitesize.appearObj = {
        ...
        init: function(options) {
            $.extend(bitesize.appearObj.settings, options || {});
    ...
    bitesize.date = {
        ...
        getRunTime: function() {
            return (bitesize.date.getTime() - bitesize.startTime) / 1e3;
        }
    };
    bitesize.dataTypes = {
    ...
    bitesize.menuFunctions = {
        ...
        menu: function() {
            ...
            $("body").find("#menu-primary-menu").on("click touchend", ".dropdown-toggle", function(e) {
                ...
                var _this = $(this);
                e.preventDefault();
                bitesize.debug.log(_this.parent("li").siblings().find(".dropdown-toggle.toggled-on"));
    ...
    $(document).ready(function() {
        ...
        bitesize.window.on("scroll.bitesizetheme", function(e) {
