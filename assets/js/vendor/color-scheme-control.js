...
( function( api ) {
	var cssTemplate = wp.template( 'bitesizetheme-color-scheme' ),
		colorSchemeKeys = [
			'background_color',
	...
	function updateCSS() {
		...
		colors.secondary_textcolor = new Color( colors.textcolor ).toCSS( 'rgba', 0.7 );
		colors.border_color = new Color( colors.textcolor ).toCSS( 'rgba', 0.1 );
		colors.border_focus_color = new Color( colors.textcolor ).toCSS( 'rgba', 0.3 );
		colors.secondary_sidebar_textcolor = new Color( colors.sidebar_textcolor ).toCSS( 'rgba', 0.7 );
		colors.sidebar_border_color = new Color( colors.sidebar_textcolor ).toCSS( 'rgba', 0.1 );
		colors.sidebar_border_focus_color = new Color( colors.sidebar_textcolor ).toCSS( 'rgba', 0.3 );
